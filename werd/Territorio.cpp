...
Territorio::adicionaFronteiraCom(Territorio* _territorio)
{
    ...
    std::cout << "(Territorio::adicionaFronteiraCom) '" << this->nome << "' est� fazendo fronteira com '" << _territorio->getNome() << "'..." << std::endl;
}
...
Territorio::getPossuidor()
{
    ...
    {
        std::cout << "(Territorio::getPossuidor) '" << this->getNome() << "' � possu�do por '" << this->castPossuidor()->getNick() << "'..." << std::endl;
    }
...
Territorio::setPossuidor(Jogador* _jogador)
{
    ...
    if (NULL == this->possuidor)
    {
        ...
        std::cout << "(Territorio::setPossuidor) '" << this->getNome() << "' n�o pertence a jogador algum. Atribu�do a '" << _jogador->getNick() << "'..." << std::endl;
    }
    else if (this->castPossuidor()->getNick() != _jogador->getNick())
    {
        this->castPossuidor()->perdeTerritorio(this);
        this->possuidor = _jogador;
        std::cout << "(Territorio::setPossuidor) '" << this->getNome() << "' atribu�do a '" << _jogador->getNick() << "'..." << std::endl;
